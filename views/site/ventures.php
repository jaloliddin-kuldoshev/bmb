...
<div class="project-heading">
    <h3><?= Yii::t('app', 'Наши совместные предприятия') ?></h3>
</div>
<!--our projects cont-->
